...
<div id="comments" class="comments-area">
	...
	<div id="collapseOne">
		...
		<ol class="comment-list">
			<?php
			wp_list_comments( array( 'callback' => 'integral_comment' ) );
			?>
		</ol><!-- .comment-list -->
	...
	<div id="collapseTwo">
		...
		$args = array(
			...
			'fields'              => array(
				'author' => '<p class="comment-form-author"><label for="author">' . __( 'Name','integral' ) . '<span class="required">*</span></label> <input class="form-control input-comment-author" id="author" name="author" type="text" value="" size="30" aria-required="true" style="width:60%; min-width:200px;" required></p>',
				'email'  => '<p class="comment-form-email"><label for="email">' . __( 'Email','integral' ) . '<span class="required">*</span></label> <input class="form-control input-comment-email" id="email" name="email" type="email" value="" size="30" aria-required="true" style="width:60%; min-width:200px;" required></p>',
				'url'    => '<p class="comment-form-url"><label for="url">' . __( 'Website','integral' ) . '</label> <input class="form-control input-comment-url" id="url" name="url" type="text" style="width:60%; min-width:200px;" value="" size="30"></p>',
			),

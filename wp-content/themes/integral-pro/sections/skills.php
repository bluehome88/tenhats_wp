        ...
        <div class="row">
			...
			<div class="col-sm-6 col-md-6">
                <?php if ($integral['skill1-name']) { ?>
                    <div class="skill">
                      <span><?php echo esc_html($integral['skill1-name']); ?></span>
                      <div class="progress">
                ...
                <?php if ($integral['skill2-name']) { ?>
                    <div class="skill">
                    <span><?php echo esc_html($integral['skill2-name']); ?></span>
                    <div class="progress">
                ...
                <?php if ($integral['skill3-name']) { ?>
                    <div class="skill">
                    <span><?php echo esc_html($integral['skill3-name']); ?></span>
                    <div class="progress">
                ...
                <?php if ($integral['skill4-name']) { ?>
                    <div class="skill">
                    <span><?php echo esc_html($integral['skill4-name']); ?></span>
                    <div class="progress">
                ...
                <?php if ($integral['skill5-name']) { ?>
                    <div class="skill"><span><?php echo esc_html($integral['skill5-name']); ?></span>
                    <div class="progress">
                ...
                <?php if ($integral['skill6-name']) { ?>
                    <div class="skill"><span><?php echo esc_html($integral['skill6-name']); ?></span>
                    <div class="progress">

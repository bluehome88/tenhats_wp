...
<div class="container">
	<div class="row">
		...
		<div class="col-md-6">
				...
				<?php if ($integral['contactinfo-brief']) { ?><div class="info"><?php echo esc_html($integral['contactinfo-brief']); ?></div><?php } ?>
		...
		<?php if ($integral['contact-pinterest']) { ?><li><a class="pinterest" target="_blank" href="<?php echo $integral['contact-pinterest']; ?>"><i class="fa fa-pinterest fa-lg"></i></a></li><?php } ?>
	            </ul>
		</div>

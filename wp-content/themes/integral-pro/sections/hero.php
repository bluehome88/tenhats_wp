...
?>
<?php global $integral; ?>
<section id="welcome" class="hero <?php if($integral['heroslider-toggle']==1) { ?>masterslider<?php } ?>" <?php if($integral['heroslider-toggle']==1) { ?>style="background:none !important;"<?php } ?>>
<?php if($integral['hero-overlay-toggle']==1) { ?><div class="blacklayer"></div><?php } ?>
<div class="container">
	<div class="row">
        <?php if($integral['heroslider-toggle']==1) { ?>
            <?php get_template_part( 'inc/masterslider' ); ?>
        <?php } ?>
		<?php if($integral['heroslider-toggle']==0) { ?>
        <div class="col-md-12">

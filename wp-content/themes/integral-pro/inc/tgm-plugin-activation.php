...
function integral_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            'name'      => __( 'Master Slider', 'integral' ),
            'slug'      => 'master-slider',
            'source'    => get_stylesheet_directory() . '/inc/plugins/master-slider.3.7.8.zip',
            'required'  => true,
        ),
        array(
            'name'      => __( 'TweetScroll Widget', 'integral' ),
            'slug'      => 'tweetscroll-widget',
            'source'    => get_stylesheet_directory() . '/inc/plugins/tweetscroll-widget.zip',
            'recommended'  => true,
        ),
        array(
            'name'      => __( 'Theme Demo Import', 'integral' ),

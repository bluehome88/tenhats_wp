...
class Integral_Our_Team_Widget extends WP_Widget {
    ...
    function widget( $args, $instance ) {
        ...
        echo '';
        if( $image_url) {
          echo '<div class="hovereffect img-circle center-block"><img src="'.$image_url.'" alt="'.$title.'" class="img-responsive"></div>';
        }
        ...
        if ($pinterest) { echo '<li><a class="pinterest" target="_blank" href="'.$pinterest.'"><i class="fa fa-pinterest fa-lg"></i></a></li>';}
        if ($website) { echo '<li><a class="website" target="_blank" href="'.$website.'"><i class="fa fa-external-link fa-lg"></i></a></li>';}
        echo '</ul>';
    ...
    function update( $new_instance, $old_instance ) {
        ...
        $instance['website'] = esc_url($new_instance['website']);
        return $instance;
    }
...
?>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('pinterest'); ?>"><?php esc_html_e('Pinterest URL', 'integral'); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('website'); ?>"><?php esc_html_e('Website/External URL', 'integral'); ?></label>

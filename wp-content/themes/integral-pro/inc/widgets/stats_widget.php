 ...
 */
class Integral_Stat_Widget extends WP_Widget {
    ...
    function __construct() {
        $widget_ops = array( 'classname' => 'wcp_image', 'description' => __('Add a stat to the homepage stats section.', 'integral') );
        parent::__construct( 'Integral_Stat', __('Integral - Stat Widget', 'integral'), $widget_ops );
    ...
    function widget( $args, $instance ) {
        ...
        if( $text ) {
          echo '<i class="fa '.$text.' staticon"></i>';
        }
        if( !$text && $image_url) {
...
?>
    <p>
        <label for="<?php echo $this->get_field_id('text'); ?>"><?php esc_html_e('Stat Icon Class', 'integral'); ?></label>
        ...
        <small><?php esc_html_e('Copy and paste the required icon class from the', 'integral'); ?> <a href="<?php echo esc_url('https://fortawesome.github.io/Font-Awesome/cheatsheet/'); ?>" target="_blank"><?php esc_html_e('Fontawesome Icons List', 'integral'); ?></a> <?php esc_html_e('and choose from 600+ icons.', 'integral'); ?></small>
    </p>
    <p>
        <label for="<?php echo $this->get_field_id('image_url'); ?>"><?php esc_html_e('Stat Image', 'integral'); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('number'); ?>"><?php esc_html_e('Stat Number', 'integral'); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('prefix'); ?>"><?php esc_html_e('Stat Prefix', 'integral'); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('suffix'); ?>"><?php esc_html_e('Stat Suffix', 'integral'); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('textarea'); ?>"><?php esc_html_e('Stat Description', 'integral'); ?></label>
...
add_action( 'widgets_init', function() {
    register_widget( 'Integral_Stat_Widget' );
} );
?>
...
?>
    <p>
        <label for="<?php echo $this->get_field_id('image_url'); ?>"><?php esc_html_e('Project Images/Gallery', 'integral'); ?></label>
        <br /><small><?php esc_html_e('Create a new gallery by selecting existing or uploading new images using the WordPress native uploader', 'integral'); ?></small>
        <fieldset>
        ...
        <input id="edit-gallery" class="button upload_gallery_button" type="button" value="<?php esc_html_e('Add/Edit Gallery','integral') ?>" />
        <input id="clear-gallery" class="button upload_gallery_button" type="button" value="<?php esc_html_e('Clear','integral') ?>" />
    ...
    <p>
        <label for="<?php echo $this->get_field_id('textarea'); ?>"><?php esc_html_e('Project Description', 'integral'); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('project_date'); ?>"><?php esc_html_e('Project Date', 'integral'); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('project_client'); ?>"><?php esc_html_e('Project Client', 'integral'); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('project_skills'); ?>"><?php esc_html_e('Project Skills', 'integral'); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('project_url'); ?>"><?php esc_html_e('Project URL', 'integral'); ?></label>

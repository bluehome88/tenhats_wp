...
?>
    <p>
        <label for="<?php echo $this->get_field_id('image_url'); ?>"><?php esc_html_e('Client Logo', 'integral'); ?></label>
        ...
        <small><?php esc_html_e('Upload the clients logo.', 'integral'); ?></small><br />
    ...
    <p>
        <label for="<?php echo $this->get_field_id('image_link'); ?>"><?php esc_html_e('Client Link', 'integral'); ?></label>
        ...
        <small><?php esc_html_e('Enter a link to the clients website.', 'integral'); ?></small>
    </p>
    <p class="img-prev">

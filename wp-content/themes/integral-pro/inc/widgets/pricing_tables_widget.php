 ...
 */
class Integral_Pricing_Tables_Widget extends WP_Widget {
    ...
    function __construct() {
        $widget_ops = array( 'classname' => 'wcp_image', 'description' => __('Add a pricing table to the homepage services section.', 'integral') );
        parent::__construct( 'Integral_pricing_table', __('Integral - Pricing Table Widget', 'integral'), $widget_ops );
    ...
    function widget( $args, $instance ) {
      ...
      echo '';
      echo '<div class="pt">';
      if ($title) { echo '<div class="pt_title">'.$title.'</div>';}
      echo '<div class="pt_main">'.$price.'<span>'.$price_sub_text.'</span></div>';
      ...
      echo '</ul>';
      if ($button_url) { echo '<div class="pt_button"><a href="'.$button_url.'" class="btn btn-lg btn-secondary">'.$button_text.'</a></div>';}
      echo '</div>';
      echo '';
      echo $after_widget;
    }
...
?>
  <p>
      <label for="<?php echo $this->get_field_id('title'); ?>"><?php esc_html_e('Title', 'integral'); ?></label>
      <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr($instance['title']); ?>" />
  </p>
  <p>
      <label for="<?php echo $this->get_field_id('price'); ?>"><?php esc_html_e('Price', 'integral'); ?></label>
  ...
  <p>
      <label for="<?php echo $this->get_field_id('price_sub_text'); ?>"><?php esc_html_e('Price Sub Text', 'integral'); ?></label>
  ...
  <p>
      <label for="<?php echo $this->get_field_id('feature_1'); ?>"><?php esc_html_e('Feature 1', 'integral'); ?></label>
  ...
  <p>
      <label for="<?php echo $this->get_field_id('feature_2'); ?>"><?php esc_html_e('Feature 2', 'integral'); ?></label>
  ...
  <p>
      <label for="<?php echo $this->get_field_id('feature_3'); ?>"><?php esc_html_e('Feature 3', 'integral'); ?></label>
  ...
  <p>
      <label for="<?php echo $this->get_field_id('feature_4'); ?>"><?php esc_html_e('Feature 4', 'integral'); ?></label>
  ...
  <p>
      <label for="<?php echo $this->get_field_id('feature_5'); ?>"><?php esc_html_e('Feature 5', 'integral'); ?></label>
  ...
  <p>
      <label for="<?php echo $this->get_field_id('feature_6'); ?>"><?php esc_html_e('Feature 6', 'integral'); ?></label>
  ...
  <p>
      <label for="<?php echo $this->get_field_id('feature_7'); ?>"><?php esc_html_e('Feature 7', 'integral'); ?></label>
  ...
  <p>
      <label for="<?php echo $this->get_field_id('feature_8'); ?>"><?php esc_html_e('Feature 8', 'integral'); ?></label>
  ...
  <p>
      <label for="<?php echo $this->get_field_id('feature_9'); ?>"><?php esc_html_e('Feature 9', 'integral'); ?></label>
  ...
  <p>
      <label for="<?php echo $this->get_field_id('feature_10'); ?>"><?php esc_html_e('Feature 10', 'integral'); ?></label>
  ...
  <p>
      <label for="<?php echo $this->get_field_id('button_text'); ?>"><?php esc_html_e('Button Text', 'integral'); ?></label>
  ...
  <p>
      <label for="<?php echo $this->get_field_id('button_url'); ?>"><?php esc_html_e('Button URL', 'integral'); ?></label>
...
add_action( 'widgets_init', function() {
    register_widget( 'Integral_Pricing_Tables_Widget' );
} );
?>
<?php
	get_template_part('inc/widgets/brands_widget');
	...
	get_template_part('inc/widgets/project_grid_widget'); 
	get_template_part('inc/widgets/our_clients_widget');
	get_template_part('inc/widgets/stats_widget');
	get_template_part('inc/widgets/our_team_widget');
	get_template_part('inc/widgets/pricing_tables_widget');

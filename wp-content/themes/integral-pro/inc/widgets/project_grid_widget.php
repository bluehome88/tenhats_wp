 ...
 */
class Integral_Projects_Grid_Widget extends WP_Widget {
    ...
    function __construct() {
        $widget_ops = array( 'classname' => 'wcp_image', 'description' => __('Add a project to the homepage projects grid section.', 'integral') );
        parent::__construct( 'Integral_projects_grid', __('Integral - Grid Project Widget', 'integral'), $widget_ops );
...
?>
	<p>
        <label for="<?php echo $this->get_field_id('title'); ?>"><?php esc_html_e('Project Title', 'integral'); ?></label>
        <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr($instance['title']); ?>" />
    </p>
    <p>
        <label for="<?php echo $this->get_field_id('image_url'); ?>"><?php esc_html_e('Project Image', 'integral'); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('image_link'); ?>"><?php esc_html_e('Project Link', 'integral'); ?></label>
        ...
        <small><?php esc_html_e('Enter a link to the project or a seperate page.', 'integral'); ?></small>
    </p>
    <p>
        ...
        <label for="<?php echo $this->get_field_id( 'link_target' ); ?>"><?php esc_html_e('Open link in new window/tab', 'integral'); ?></label>
    </p>
    <p>
...
add_action( 'widgets_init', function() {
    register_widget( 'Integral_Projects_Grid_Widget' );
} );
?>
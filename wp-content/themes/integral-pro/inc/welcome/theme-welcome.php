...
class Integral_Welcome {
	...
	public function integral_welcome_register_menu() {
		add_theme_page( __( 'Setup Integral Pro', 'integral' ), __( 'Setup Integral Pro', 'integral' ), 'activate_plugins', 'integral-welcome', array( $this, 'integral_welcome_screen' ) );
	}
	...
	public function integral_activation_admin_notice() {
		...
		if ( is_admin()) {
			...
			if($current_theme->get('Name')== "Integral Pro" && !$welcome_dismissed){
		...
		?>
			<div class="notice theme-notice">
				...
				<div class="theme-notice-message wp-theme-fresh">
					<strong><?php esc_html_e( 'Thank you for choosing Integral Pro! ', 'integral' ); ?></strong><br />
					<?php esc_html_e( 'Follow our instructions to setup your new theme, import demo content and start customizing your site.', 'integral' ); ?></div>
				<div class="theme-notice-cta">
					<a href="<?php echo esc_url( admin_url( 'themes.php?page=integral-welcome#getting_started' ) ); ?>" class="button button-primary button-hero" style="text-decoration: none;"><?php esc_html_e( 'Setup Integral Pro', 'integral' ); ?> <?php echo $dismiss_url ?></a>
				</div>
			</div>
		<?php
	}
	...
	public function integral_welcome_screen() {
		...
		<div class="wrap about-wrap theme-welcome">
            ...
            <h1><?php esc_html_e('Welcome to Integral Pro', 'integral'); ?> <span><?php esc_html_e('VERSION 1.5.5', 'integral'); ?></span></h1>

            <div class="about-text"><?php esc_html_e('Integral Pro is a powerful one-page theme for professionals, agencies and businesses. Its strength lies in displaying content on a single page in a simple and elegant manner. It\'s super easy to customize and allows you to create a stunning website in minutes.', 'integral'); ?></div>

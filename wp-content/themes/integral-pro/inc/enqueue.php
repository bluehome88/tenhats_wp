...
function integral_scripts() {  
    ...
    wp_enqueue_style('integral_fontawesome5', get_template_directory_uri().'/css/all.min.css');
    wp_enqueue_style('integral_fontawesome4shim', get_template_directory_uri().'/css/v4-shims.min.css');
    ...
    wp_enqueue_script('integral_waypoints_js', get_template_directory_uri().'/js/waypoints.min.js', array('jquery'), '2.0.5', true );
    wp_enqueue_script('integral_counterup_js', get_template_directory_uri().'/js/jquery.counterup.min.js', array('jquery'), '1.0', true );
    
    if( ! wp_is_mobile() ) {
        wp_enqueue_script('integral_scrollreveal_js', get_template_directory_uri().'/js/scrollreveal.min.js', array('jquery'), '3.3.2', true );
    }

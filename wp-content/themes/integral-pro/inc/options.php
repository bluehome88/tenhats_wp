...
Redux::setSection($opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            'id' => 'gen-typography-bigtitle-horizontal-lines-toggle',
            'type' => 'switch',
            'default' => true,
            'title' => __('Disable Horizontal Lines', 'integral') ,
            'subtitle' => __('Toggle off to disable the horizontal lines which appear to the left and right of the H2 Big Titles', 'integral') ,
        ) ,
        array(
...
Redux::setSection($opt_name, array(
    ...
    'fields' => array(
        array(
            ...
            'subtitle' => __('Pick a color for the main buttons', 'integral') ,
            'default' => '#00aded',
        ) ,
        array(
            'id' => 'theme-color',
        ...
        array(
            ...
            'output' => array(
                'color' => '.lite .bigtitle, .lite .heading .fa'
            ) ,
        ...
        array(
            ...
            'title' => __('H2 Big Title Font Color', 'integral') ,
            'output' => array(
                'color' => '.dark h2.bigtitle_dark, .dark .heading .fa'
            ) ,
        ...
        array(
            ...
            'subtitle' => __('Change the body font color of the dark sections (Services, Pricing Tables & Contact). Default is #888888.', 'integral') ,
        ) ,
        array(
            'id' => 'darksection-end',
            'type' => 'section',
...
Redux::setSection($opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'default' => 'A simple & elegant theme for freelancers, agencies and businesses.
Perfect to promote your work or business.',
        ) ,
        array(
            'id' => 'hero-btn1-toggle',
            'type' => 'switch',
        ...
        array(
            'id' => 'heroslider-start',
            'type' => 'section',
            'title' => __('Master Slider (Image & Content Slider)', 'integral') ,
            'subtitle' => __('The Master Slider Wordpress Plugin is used for adding image sliders to the Welcome section. Make sure you have installed and enabled the plugin before enabling the slider. To configure the slider settings, in the Admin Panel go to MASTER SLIDER > Settings.', 'integral') ,
            'indent' => true,
        ) ,
        array(
            'id' => 'heroslider-toggle',
            'type' => 'switch',
            'default' => false,
            'title' => __('Enable Image Slider', 'integral') ,
            'subtitle' => __('Toggle ON to use the Master Slider plugin to display an image slider instead of the static background image.', 'integral') ,
        ) ,
        array(
            'id' => 'heroslider-bg-toggle',
            'type' => 'switch',
            'default' => false,
            'title' => __('Set slider as background', 'integral') ,
            'subtitle' => __('Toggle ON to use the slider as the background for the welcome section', 'integral') ,
            'required' => array(
                'heroslider-toggle',
                "=",
                '1'
        ...
        array(
            'id' => 'heroslider-shortcode',
            'type' => 'text',
            'title' => __('Slider Shortcode', 'integral') ,
            'subtitle' => __('In the Admin Panel, go to MASTER SLIDER > Master Slider to get the slider shortcode.', 'integral') ,
            'default' => '[masterslider id="1"]',
        ) ,
        array(
            'id' => 'heroslider-end',
            'type' => 'section',
...
Redux::setSection($opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            'id' => 'brands-background',
            'type' => 'color',
            'title' => __('Background Color', 'integral') ,
            'output' => array(
                'background-color' => '.brands'
            ) ,
            'subtitle' => __('Set the background color of the Brands section.', 'integral') ,
            'desc' => __('Default color is #EEEEEE.', 'integral') ,
            'default' => '#eeeeee',
        ) ,
        array(
            'id' => 'brands-layout',
        ...
        array(
            ...
            'type' => 'spacing',
            'title' => __('Section Padding', 'integral') ,
            'subtitle' => __('Set the padding of the top and bottom of this section. You can also use this to increase or decrease the height of this section.', 'integral') ,
            'output' => array(
                '.brands'
            ) ,
            'compiler' => 'true',
...
Redux::setSection($opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            'id' => 'features-layout',
            'type' => 'select',
            'title' => __('Feature Layout', 'integral') ,
...
Redux::setSection($opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'compiler' => 'true',
            'default' => array(
                'background-image' => get_stylesheet_directory_uri() . '/images/bg-testimonials.jpg',
                'background-size' => 'cover',
            )
        ) ,
        array(
...
Redux::setSection($opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'type' => 'select',
            'title' => __('Content', 'integral') ,
            'subtitle' => __('Add content section ABOVE the services widgets.', 'integral') ,
            'desc' => __('Select the page you want to pull content from to populate this section', 'integral') ,
            'data' => 'pages',
        ) ,
        array(
            ...
            'type' => 'select',
            'title' => __('Content', 'integral') ,
            'subtitle' => __('Add content section BELOW the services widgets.', 'integral') ,
            'desc' => __('Select the page you want to pull content from to populate this section.', 'integral') ,
            'data' => 'pages',
        ) ,
        array(
...
Redux::setSection($opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'default' => true,
            'title' => __('Disable Section', 'integral') ,
            'subtitle' => __('Toggle off to disable the pricimg tables section.', 'integral') ,
        ) ,
    )
));
...
Redux::setSection($opt_name, array(
    ...
    'fields' => array(
        array(
            ...
            'compiler' => 'true',
            'default' => array(
                'background-image' => get_stylesheet_directory_uri() . '/images/bg-cta.jpg',
                'background-size' => 'cover',
            )
        ) ,
        array(
...
Redux::setSection($opt_name, array(
    ...
    'desc' => __('Display your latest instagram photos. In order for this feature to function you must first install the <a href="https://wordpress.org/plugins/instagram-feed/" target="_blank">Smash Balloon Instagram Feed</a> plugin.', 'integral') ,
    'fields' => array(
        array(
            'id' => 'instagram-shortcode',
            'type' => 'textarea',
            'title' => __('Plugin Shortcode', 'integral') ,
            'subtitle' => __('Make sure you have installed the Smash Balloon Instagram Feed plugin and connected your Instagram account. Then paste the shortcode in the field on the right.', 'integral') ,
            'description' => __('Paste the shortcode in the field above.', 'integral') ,
            'default' => '[instagram-feed num=6 cols=6 width=100 widthunit=% showheader=false showbutton=false showfollow=true imagepadding=0]'
        ) ,
        array(
            'id' => 'instagram-padding',
            'type' => 'spacing',
            'title' => __('Section Padding', 'integral') ,
            'subtitle' => __('Set the padding of the top and bottom of this section. You can also use this to increase or decrease the height of this section.', 'integral') ,
            'output' => array(
        ...
        array(
            'id' => 'instagram-custom-class',
            'type' => 'text',
            'title' => __('Custom Class', 'integral') ,
            'subtitle' => __('Append a custom CSS class to this section.', 'integral') ,
        ) ,
        array(
            'id' => 'instagram-section-toggle',
            'type' => 'switch',
            'default' => true,
            'title' => __('Disable Section', 'integral') ,
            'subtitle' => __('Toggle off to disable the instagram section.', 'integral') ,
        ) ,
    )
));
...
Redux::setSection($opt_name, array(
    ...
    'fields' => array(
        array(
            'id' => 'tweets-create',
            'type' => 'raw',
            'title' => __('Add Tweets Scroll', 'integral') ,
...
Redux::setSection($opt_name, array(
    ...
    'fields' => array(
        array(
            ...
            'compiler' => 'true',
            'default' => array(
                'background-image' => get_stylesheet_directory_uri() . '/images/bg-newsletter.jpg',
                'background-size' => 'cover',
            )
        ) ,
        array(
...
Redux::setSection($opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'type' => 'text',
            'title' => __('Pinterest URL', 'integral') ,
            'default' => '#',
        ) ,
        array(
            'id' => 'contactinfo-end',
...
Redux::setSection($opt_name, array(
    ...
    'fields' => array(
        array(
            'id' => 'extra1-style',
            'type' => 'select',
            'title' => __('Section Style', 'integral') ,
            'subtitle' => __('Select if you want this to be a Lite or Dark section.', 'integral') ,
            'options' => array(
                'lite' => __('Lite', 'integral') ,
                'dark' => __('Dark', 'integral') ,
            ) ,
            'default' => 'lite'
        ) ,
        array(
            'id' => 'extra1-title-style',
            'type' => 'select',
            'title' => __('Title Style', 'integral') ,
            'subtitle' => __('Select the title style', 'integral') ,
            'options' => array(
                'bigtitle' => __('Big Title', 'integral') ,
                'smalltitle' => __('Small Title', 'integral') ,
            ) ,
            'default' => 'bigtitle'
        ) ,
        array(
        ...
        array(
            ...
            'type' => 'editor',
            'title' => __('Subtitle', 'integral') ,
            'default' => 'This is the subtitle for the additional content section.',
            'required' => array(
                'extra1-title-style',
                "=",
                'bigtitle'
        ...
        array(
            'id' => 'extra1-widgets',
            'type' => 'select',
            'title' => __('Widgets Layout', 'integral') ,
            'subtitle' => __('You can also display widgets by adding widgets to the Extra 1 Sidebar. Configure the number of widgets to appear in a row. Additional widgets will automatically default to the next row.', 'integral') ,
            'options' => array(
                '2' => __('6 per row (6 columns)', 'integral') ,
                '3' => __('4 per row (4 columns)', 'integral') ,
                '4' => __('3 per row (3 columns)', 'integral') ,
        ...
        array(
            'id' => 'extra1-section-toggle',
            'type' => 'switch',
            'default' => true,
            'title' => __('Disable Section', 'integral') ,
            'subtitle' => __('Toggle off to disable this section.', 'integral') ,
        ) ,
    )
));
...
Redux::setSection($opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'type' => 'select',
            'title' => __('Widgets Layout', 'integral') ,
            'subtitle' => __('You can also display widgets by adding widgets to the Extra 2 Sidebar. Configure the number of widgets to appear in a row. Additional widgets will automatically default to the next row.', 'integral') ,
            'options' => array(
                '2' => __('6 per row (6 columns)', 'integral') ,
                '3' => __('4 per row (4 columns)', 'integral') ,
                '4' => __('3 per row (3 columns)', 'integral') ,

...
Integral One Page Business Theme - Build a professional website for your business with Integral free WordPress theme. Its strength lies in displaying content on a single page in a simple and elegant manner. It's super easy to customize and allows you to create a stunning website in minutes. It boasts a rich color scheme with light and dark sections and a clean, minimal, modern design with smooth parallax effect. Integral is built with Bootstrap, is responsive and integrates with popular plugins like Contact Form 7, Woocommerce. Integral is now compatible with Elementor & Beaver Builder page-builders. Perfect for professionals, agencies, small business, corporate business, startup, freelancer, development company, personal, portfolio, blog, real estate, lawyer, travel and photography websites.

== Copyright ==

Integral WordPress Theme, Copyright 2016 Ishmael 'Hans' Desjarlais

Integral is distributed under the terms of the GNU GPL
...
(C) 2015 Stéphane Caron – No Margin For Errors 
Licensed under the GNU General Public License v2.0,
http://www.gnu.org/licenses/gpl-2.0.html
OR
...
(C) 2016 Justin Tadlock.
Licensed under the GNU General Public License v2.0,
http://www.gnu.org/licenses/gpl-2.0.html
###

###
Integral uses royalty-free stock photography from Unsplash.com, Pexels.com and Stocksy.com
License: 
bg-welcome.jpg is from Stocksy and is licensed under their Extended "PRODUCTS FOR RESALE" license. All remaining images from Unsplash and Pexels and are licensed under the terms of the Creative Commons Zero, http://creativecommons.org/publicdomain/zero/1.0/

* images/bg-welcome.jpg
Source: https://www.stocksy.com/42751
	
* images/bg-testimonials.jpg
Source: https://unsplash.com/photos/a2NRu2Wxa2o
 
* images/bg-cta.png
Source: https://unsplash.com/photos/GANqCr1BRTU
 
* images/bg-newsletter.jpg
Source: https://unsplash.com/photos/kZvmEpyfiJs
###

###
Fonts - Montserrat, Open Sans and Cabin by Google Fonts
###
...
2. Apply the theme.
3. Install Redux Framework and Contact Form 7 plugins.
4. Create page entitled "Home"
5. Set "home" page as the static front-page in your settings.
6. Go to Appearance > Customize in main menu and configure your theme's settings.
...
### 1.4.9.4 - July 16th, 2020

**Changes:**

- Changed live demo import instructions
- Added Theme Demo Import plugin to TGMPA


### 1.4.9.3 - June 24th, 2020

**Changes:**

- Tested with WordPress 5.4.2
- Ran Theme Check plugin and fix required items
- Ran Theme Sniffer plugin and fixed errors


### 1.4.9.2 - June 1st, 2020
...
- Added read more link to post excerpt


### 1.4.7.1 - Jan 29th, 2020
